...
const CreateTask = () => {
  return (
    ...
    <form className="flex flex-wrap w-full items-start justify-between">
        ...
        <input className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="text" placeholder="Make a video" />
        </div>
            {/* date */}
      <div>
        <h3 className="text-sm text-gray-300 mb-0.5">Date : 22/10/24</h3>
        <input className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="date" placeholder="dd/mm/yy" />
      </div>
      {/* assign  */}
      <div>
